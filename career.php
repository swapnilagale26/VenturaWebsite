...
<div class="top-head-section section-block-grey background-center "  style="background-image: url('img/slider/careers.png');background-size: cover;">
      ...
      <div class="modal-body">
       ...
       <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        ...
        <!-- 16:9 aspect ratio -->
         ...
         <!--   <iframe class="embed-responsive-item" src="img/new-img/video.mp4" id="video"  allowscriptaccess="always" allow="autoplay"></iframe>  -->
          <!--   <iframe src="img/video/team-video.mp4" height="200" width="100%"></iframe>  -->
          <iframe width="420" height="345" src="img/video/team-video.mp4">
</iframe>
        </div>
